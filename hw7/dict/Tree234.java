...
public class Tree234 extends IntDictionary {
    ...
    public void insert(int key) {
        ...
        if (!find(key)) {
            if (root == null) {
                root = new Tree234Node(key, null, null);
            }
            Tree234Node node = root;
            while (node.child1 != null) {
                ...
                if (node.parent.keys == 3) {
                    node.parent = node.parent.moveMiddle();
                }
            }
            ...
            if (node.keys == 1) {
                ...
                if (key < node.key1) {
                    ...
                    Tree234Node n = nextChild(node.moveMiddle());
