...
public class PixImage {
    ...
    private short neighborRED(int x, int y) {
        short r = 0;
        if (position(x, y) == "in") {
            r = (short)(( getRed(x -1, y-1) + pixel[x][y - 1][0] + pixel[x + 1][y - 1][0] + pixel[x - 1][y][0] +
                    pixel[x][y][0] + pixel[x + 1][y][0] + pixel[x - 1][y + 1][0] + pixel[x][y + 1][0] +
                    pixel[x + 1][y + 1][0] ) / 9);
        }
        if (position(x, y) == "top") {
            r = (short)(( pixel[x - 1][y][0] + pixel[x][y][0] + pixel[x + 1][y][0] + pixel[x - 1][y + 1][0] +
                    pixel[x][y + 1][0] + pixel[x + 1][y + 1][0] ) / 6);
        }
        if (position(x, y) == "buttom") {
            r = (short)(( pixel[x - 1][y - 1][0] + pixel[x][y - 1][0] + pixel[x + 1][y - 1][0] +
                    pixel[x - 1][y][0] + pixel[x][y][0] + pixel[x + 1][y][0] ) / 6);
        }
        if (position(x, y) == "left") {
            r = (short)(( pixel[x][y - 1][0] + pixel[x + 1][y - 1][0] + pixel[x][y][0] +
                    pixel[x + 1][y][0] + pixel[x][y + 1][0] + pixel[x + 1][y + 1][0] ) / 6);
        }
        if (position(x, y) == "right") {
            r = (short)(( pixel[x - 1][y - 1][0] + pixel[x][y - 1][0] + pixel[x - 1][y][0] +
                    pixel[x][y][0] + pixel[x - 1][y + 1][0] + pixel[x][y + 1][0] ) / 6);
        }
        if (position(x, y) == "topleft") {
            r = (short)(( pixel[x][y][0] + pixel[x + 1][y][0] + pixel[x][y + 1][0] + pixel[x + 1][y + 1][0] ) / 4);
        }
        if (position(x, y) == "topright") {
            r = (short)(( pixel[x - 1][y][0] + pixel[x][y][0] + pixel[x - 1][y + 1][0] + pixel[x][y + 1][0] ) / 4);
        }
        if (position(x, y) == "buttomleft") {
            r = (short)(( pixel[x][y - 1][0] + pixel[x + 1][y - 1][0] + pixel[x][y][0] + pixel[x + 1][y][0] ) / 4);
        }
        if (position(x, y) == "buttomright") {
            r = (short)(( pixel[x - 1][y - 1][0] + pixel[x][y - 1][0] + pixel[x - 1][y][0] + pixel[x][y][0] ) / 4);
        }
        return r;
    }
    ...
    private short neighborGREEN(int x, int y) {
        ...
        if (x > 0 && x < width - 1 && y > 0 && y < height -1) {
            r = (short)(( pixel[x - 1][y - 1][1] + pixel[x][y - 1][1] + pixel[x + 1][y - 1][1] + pixel[x - 1][y][1] +
                    pixel[x][y][1] + pixel[x + 1][y][1] + pixel[x - 1][y + 1][1] + pixel[x][y + 1][1] +
                    pixel[x + 1][y + 1][1] ) / 9);
        }
        if (x > 0 && x < width - 1 && y == 0) {
            r = (short)(( pixel[x - 1][y][1] + pixel[x][y][1] + pixel[x + 1][y][1] + pixel[x - 1][y + 1][1] +
                    pixel[x][y + 1][1] + pixel[x + 1][y + 1][1] ) / 6);
        }
        if (x > 0 && x < width - 1 && y == height - 1) {
            r = (short)(( pixel[x - 1][y - 1][1] + pixel[x][y - 1][1] + pixel[x + 1][y - 1][1] +
                    pixel[x - 1][y][1] + pixel[x][y][1] + pixel[x + 1][y][1] ) / 6);
        }
        if (x == 0 && y > 0 && y < height - 1) {
            r = (short)(( pixel[x][y - 1][1] + pixel[x + 1][y - 1][1] + pixel[x][y][1] +
                    pixel[x + 1][y][1] + pixel[x][y + 1][1] + pixel[x + 1][y + 1][1] ) / 6);
        }
        if (x == width - 1 && y > 0 && y < height - 1) {
            r = (short)(( pixel[x - 1][y - 1][1] + pixel[x][y - 1][1] + pixel[x - 1][y][1] +
                    pixel[x][y][1] + pixel[x - 1][y + 1][1] + pixel[x][y + 1][1] ) / 6);
        }
        if (x == 0 && y == 0) {
            r = (short)(( pixel[x][y][1] + pixel[x + 1][y][1] + pixel[x][y + 1][1] + pixel[x + 1][y + 1][1] ) / 4);
        }
        if (x == width - 1 && y == 0) {
            r = (short)(( pixel[x - 1][y][1] + pixel[x][y][1] + pixel[x - 1][y + 1][1] + pixel[x][y + 1][1] ) / 4);
        }
        if (x == 0 && y == height - 1) {
            r = (short)(( pixel[x][y - 1][1] + pixel[x + 1][y - 1][1] + pixel[x][y][1] + pixel[x + 1][y][1] ) / 4);
        }
        if (x == width - 1 && y == height - 1) {
            r = (short)(( pixel[x - 1][y - 1][1] + pixel[x][y - 1][1] + pixel[x - 1][y][1] + pixel[x][y][1] ) / 4);
        }
        return r;
    }
    ...
    private short neighborBLUE(int x, int y) {
        short r = 0;
        if (x > 0 && x < width - 1 && y > 0 && y < height -1) {
            r = (short)(( pixel[x - 1][y - 1][2] + pixel[x][y - 1][2] + pixel[x + 1][y - 1][2] + pixel[x - 1][y][2] +
                    pixel[x][y][2] + pixel[x + 1][y][2] + pixel[x - 1][y + 1][2] + pixel[x][y + 1][2] +
                    pixel[x + 1][y + 1][2] ) / 9);
        }
        if (x > 0 && x < width - 1 && y == 0) {
            r = (short)(( pixel[x - 1][y][2] + pixel[x][y][2] + pixel[x + 1][y][2] + pixel[x - 1][y + 1][2] +
                    pixel[x][y + 1][2] + pixel[x + 1][y + 1][2] ) / 6);
        }
        if (x > 0 && x < width - 1 && y == height - 1) {
            r = (short)(( pixel[x - 1][y - 1][2] + pixel[x][y - 1][2] + pixel[x + 1][y - 1][2] +
                    pixel[x - 1][y][2] + pixel[x][y][2] + pixel[x + 1][y][2] ) / 6);
        }
        if (x == 0 && y > 0 && y < height - 1) {
            r = (short)(( pixel[x][y - 1][2] + pixel[x + 1][y - 1][2] + pixel[x][y][2] +
                    pixel[x + 1][y][2] + pixel[x][y + 1][2] + pixel[x + 1][y + 1][2] ) / 6);
        }
        if (x == width - 1 && y > 0 && y < height - 1) {
            r = (short)(( pixel[x - 1][y - 1][2] + pixel[x][y - 1][2] + pixel[x - 1][y][2] +
                    pixel[x][y][2] + pixel[x - 1][y + 1][2] + pixel[x][y + 1][2] ) / 6);
        }
        if (x == 0 && y == 0) {
            r = (short)(( pixel[x][y][2] + pixel[x + 1][y][2] + pixel[x][y + 1][2] + pixel[x + 1][y + 1][2] ) / 4);
        }
        if (x == width - 1 && y == 0) {
            r = (short)(( pixel[x - 1][y][2] + pixel[x][y][2] + pixel[x - 1][y + 1][2] + pixel[x][y + 1][2] ) / 4);
        }
        if (x == 0 && y == height - 1) {
            r = (short)(( pixel[x][y - 1][2] + pixel[x + 1][y - 1][2] + pixel[x][y][2] + pixel[x + 1][y][2] ) / 4);
        }
        if (x == width - 1 && y == height - 1) {
            r = (short)(( pixel[x - 1][y - 1][2] + pixel[x][y - 1][2] + pixel[x - 1][y][2] + pixel[x][y][2] ) / 4);
        }
        return r;
    }
