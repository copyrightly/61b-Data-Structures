...
public class RunIterator implements Iterator {
     ...
     */
    private DoublyLinkedList.Node curIterator;
    ...
    // the encoding.
    RunIterator(DoublyLinkedList.Node node) {
    ...
    public boolean hasNext() {
        ...
        if (curIterator.next.next != null) return true;
        else return false;
    }
    ...
    public int[] next() throws NoSuchElementException {
        ...
        // Replace the following line with your solution.
        if (curIterator.next == null) {
            throw new NoSuchElementException();
        } else {
            int[] a = {curIterator.run.length, curIterator.run.red, curIterator.run.green, curIterator.run.blue};
