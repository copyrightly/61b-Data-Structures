...
public class DList {
     ...
     *  An empty DList is signified by a sentinel node that points to itself.
     */
    public DList() {
...
//        head.prev = head;
    ...
    public void insertAfter(Object item, DListNode node) {
        if (node == null);
            ...
            DListNode newest = newNode(item, node, node.next);
    ...
    public void insertBefore(Object item, DListNode node) {
        if (node == null);
            ...
            DListNode newest = newNode(item, node.prev, node);
...
//        list.insertBack("ab");
        ...
        System.out.println(list.head.next);
        System.out.println(list.head.prev);
        System.out.println(list.head.next.prev);
        System.out.println(list.head.prev.next);
